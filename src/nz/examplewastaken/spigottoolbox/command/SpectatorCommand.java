...
/**
 * Represents the spectator game mode command.
 * @author ExampleWasTaken
 */
public class SpectatorCommand implements CommandExecutor {

    /**
     * Sets the executing player into spectator mode.
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] strings) {
        ...
        if (sender instanceof Player) {
            ...
            if (player.getGameMode() != GameMode.SPECTATOR) {
                ...
                player.sendMessage(Util.getPrefix() + ChatColor.GREEN + "Changed to " + ChatColor.WHITE + "Spectator");
            } else {
                player.sendMessage(Util.getPrefix() + ChatColor.RED + "Your game mode is already " + ChatColor.WHITE + "Spectator" + ChatColor.RED + "!");
            }
        } else {
